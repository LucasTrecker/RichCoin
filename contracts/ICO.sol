...
contract ICO is ReentrancyGuard{
    ...
    constructor(address _rctAddress){
        ...
        uint256 stage1Token = 10; //1000000
        uint256 stage2Token = 20; //1000000
        uint256 stage3Token = 40; //1000000
        ...
        _stageToPrice[1] = 10; //100000000000000
        _stageToPrice[2] = 20; //200000000000000
        _stageToPrice[3] = 40; //400000000000000
